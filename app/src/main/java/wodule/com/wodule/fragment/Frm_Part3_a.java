 ...
 */
public class Frm_Part3_a extends BaseTFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.frmpart3_a, container, false);
...
//                ActAssessmentStartA.storeresult.setPart_1_score(score);
    ...
    public void onClick(View v) {
        ...
        if (v.getId()==R.id.ivNext){
            Frm_Part4_a fragment1 = new Frm_Part4_a();
